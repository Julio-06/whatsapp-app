<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
        <form action="{{ route('contacts.update', $contact->id) }}" method="post" class="bg-white rounded-lg shadow p-6">
            ...
            <div class="mb-4">
                ...
                <x-jet-input type="email" name="email" value="{{ old('email', $contact->user->email) }}" class="w-full" placeholder="Ingrese el correo del contacto"/>
